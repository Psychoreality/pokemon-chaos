...
#define ABILITY_NOBLE_AURA 311
#define ABILITY_SHREDDER 312

#define ABILITIES_COUNT_CUSTOM 2

#define ABILITIES_COUNT ABILITIES_COUNT_GEN9 + ABILITIES_COUNT_CUSTOM
