...
#define MOVE_MONSTER_MASH (MOVES_COUNT + 35)
#define MOVE_SONIC_SHOCKWAVE (MOVES_COUNT + 36)

#define FIRST_Z_MOVE        MOVE_BREAKNECK_BLITZ
#define LAST_Z_MOVE         MOVE_SONIC_SHOCKWAVE
...
#define MOVE_MAX_FRIGHTEN       (FIRST_MAX_MOVE + 52)
#define MOVE_MAX_VOLUME         (FIRST_MAX_MOVE + 53)

#define FIRST_MAX_MOVE        MOVES_COUNT_Z
#define LAST_MAX_MOVE         MOVE_MAX_VOLUME
