...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("Cool Trainer"), 12, BALL_ULTRA },
    ...
    [TRAINER_CLASS_AROMA_LADY] = { _("Aroma Lady"), 10, BALL_HEAL },
    ...
    [TRAINER_CLASS_LEADER] = { _("Gym Leader"), 25 },
    ...
    [TRAINER_CLASS_CHAMPION] = { _("Champion"), 50, BALL_MASTER },
    ...
    [TRAINER_CLASS_SIS_AND_BRO] = { _("Bro and Sis"), 3 },
